...
export const agents = pgTable('agents', {
	...
	hooks: jsonb('hooks').$type<import('@commandra/shared').AgentHooks>(),
	llmConfig: jsonb('llm_config').$type<import('@commandra/shared').AgentLLMConfig>(),
	limits: jsonb('limits').$type<import('@commandra/shared').AgentLimits>(),
	domainAutonomy: jsonb('domain_autonomy').$type<Record<string, import('@commandra/shared').AgentAutonomy>>(),
